...
# Xiaorui Liu
**Big Data Engineer/Python.C++/Machine Learning/Distribute System** | **Montreal, Quebec, Canada**\
...
## Summary
Results-driven data engineer with expertise in designing and optimizing scalable data architectures and machine learning pipelines. Proven ability to improve data processing systems at Fluent.ai and Alibaba, reducing processing times and increasing efficiency. Skilled in Python, C++, and Java, with a passion for developing innovative solutions in big data, machine learning, and distributed system architectures. Proficient in Apache Airflow, Kafka, Hadoop, Hive, MySQL, Azure, and Docker. Adept at integrating advanced technologies to deliver impactful, scalable results.
